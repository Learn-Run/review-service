...
public enum ErrorCode {
    ...
    FAILED_TO_FIND_MEMBER_REVIEW(HttpStatus.INTERNAL_SERVER_ERROR, false, 6008, "회원 리뷰 집계 정보 조회에 실패했습니다."),
    FAILED_TO_INITIALIZE_MEMBER_REVIEW(HttpStatus.INTERNAL_SERVER_ERROR, false, 6009, "회원 리뷰 초기화에 실패하였습니다.");
